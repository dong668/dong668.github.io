...
(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		_loadAjaxFile: function(awidget, file, loader) {
			...
			awidget.find('.widget-body').load(file,
		...
		init: function() {
			...
			self.widget.each(function() {
				...
				if (!thisHeader.parent().attr('role')) {
					 ...
					 **/
					thisHeader.append('<span class="jarviswidget-loader"><i class="icon icon-refresh icon-spin"></i></span>');
			 ...
			 **/
			$(self.o.deleteSettingsKey).on(clickEvent, this,
				function(e) {
					if (storage && self.o.localStorage) {
			 ...
			 **/
			$(self.o.deletePositionKey).on(clickEvent, this,
				function(e) {
					if (storage && self.o.localStorage) {
		...
		_clickEvents: function() {
			 ...
			 **/
			self.widget.on(clickEvent, '.jarviswidget-toggle-btn',
				function(e) {
					...
					if (pWidget.hasClass('jarviswidget-collapsed')) {
						tWidget.children().removeClass(self.toggleClass[1]).addClass(self.toggleClass[0]).parents(self.o.widgets).removeClass('jarviswidget-collapsed').children('[role=content]').slideDown(self.o.toggleSpeed,
							function() {
								self._saveSettingsWidget();
							});
					} else {
						tWidget.children().removeClass(self.toggleClass[0]).addClass(self.toggleClass[1]).parents(self.o.widgets).addClass('jarviswidget-collapsed').children('[role=content]').slideUp(self.o.toggleSpeed,
							function() {
								self._saveSettingsWidget();
							});
					}
			 ...
			 **/
			self.widget.on(clickEvent, '.jarviswidget-fullscreen-btn',
				function(e) {
			 ...
			 **/
			self.widget.on(clickEvent, '.jarviswidget-edit-btn',
				function(e) {
					...
					if (tWidget.find(self.o.editPlaceholder).is(':visible')) {
						$(this).children().removeClass(self.editClass[1]).addClass(self.editClass[0]).parents(self.o.widgets).find(self.o.editPlaceholder).slideUp(self.o.editSpeed,
							function() {
								self._saveSettingsWidget();
							});
					} else {
			 ...
			 * Set a custom style.
			 **/
			self.widget.on(clickEvent, '[data-widget-setstyle]',
				function(e) {
			 ...
			 * Allow users to show/hide a edit box.
			 **/
			self.widget.on(clickEvent, '.jarviswidget-custom-btn',
				function(e) {
			 ...
			 **/
			self.widget.on(clickEvent, '.jarviswidget-delete-btn',
				function(e) {
					 ...
					 **/
					$.SmartMessageBox({
							title: "<i class='icon icon-times' style='color:#ed1c24'></i> " + self.o.labelDelete + ' "' + widTitle + '"',
						...
						function(ButtonPressed) {
							...
							if (ButtonPressed == "Yes") {
								 ...
								 **/
								$('#' + removeId).fadeOut(self.o.deleteSpeed,
									function() {
			 ...
			 **/
			self.widget.on(clickEvent, '.jarviswidget-refresh-btn',
				function(e) {
